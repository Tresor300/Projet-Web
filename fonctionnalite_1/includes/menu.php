    ...
    <nav>
        <ul>
            ...
            <li class="<?php echo (isset($page_active) && $page_active == 'statistiques') ? 'active' : ''; ?>">
                <a href="/projet_web/fonctionnalite_3/php/statistiques.php">
                    <span class="icon">
            ...
            <li class="<?php echo (isset($page_active) && $page_active == 'ia_clusters') ? 'active' : ''; ?>">
                <a href="/projet_web/fonctionnalite_4/php/clusters.php">
                    <span class="icon">
            ...
            <li class="<?php echo (isset($page_active) && $page_active == 'ia_classification') ? 'active' : ''; ?>">
                <a href="/projet_web/fonctionnalite_5/html/prediction.php">
                    <span class="icon">
